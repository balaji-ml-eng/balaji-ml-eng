...
I don't just research — I **build real, scalable solutions**. From prototyping to production, I ship AI systems that solve actual problems. I'm also a big believer in **working smart** — I leverage the latest AI tools and automation to build faster, iterate quicker, and focus on what matters. Why do manually what AI can handle?
...
[![Pandas](https://img.shields.io/badge/Pandas-150436?style=for-the-badge&logo=pandas&logoColor=white)](https://pandas.pydata.org/)
...
|---------|-------------|--------|------|
| **SLP** | Speech Language Processing pipeline | 🗣️ Speech AI | Python, ML |
| **text2speech** | Text-to-Speech synthesis system | 🗣️ TTS | Python |
| **Pronunciation_project** | AI-powered pronunciation assessment | 🗣️ Speech | JavaScript, ML |
| **Aihealthcare-Bot** | Intelligent healthcare chatbot with NLP | 🤖 NLP / Healthcare | TypeScript |
| **Forex-Predictor** | ML-based financial prediction system | 📈 Predictive AI | HTML, ML |
| **Final-device-based-STT_TTS** | Device-level speech recognition & synthesis | 🗣️ STT/TTS | Python |
